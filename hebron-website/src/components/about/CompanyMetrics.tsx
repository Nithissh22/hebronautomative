...
const salesData = [
  { year: '2021-22', sales: 1800, fill: '#4a78a8' },
  { year: '2022-23', sales: 2400, fill: '#ab4b49' },
  { year: '2023-24', sales: 3200, fill: '#8b9f50' },
  { year: '2024-25', sales: 4100, fill: '#6b5885' },
  { year: '2025-26', sales: 5200, fill: '#4691a4' },
  { year: '2026-27', sales: 6700, fill: '#d48239' }
];
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={salesData} margin={{ top: 20, right: 30, left: 20, bottom: 40 }}>
                  ...
                  <Bar dataKey="sales" radius={[4, 4, 0, 0]}>
                    ...
                    <LabelList dataKey="sales" position="top" style={{ fontSize: '11px', fill: '#475569' }} />
                  </Bar>
                </BarChart>
              </ResponsiveContainer>
            </div>
            <div style={{ textAlign: 'center', fontSize: '12px', fontWeight: 'bold', marginTop: '10px' }}>Sale Value in "Lakhs"</div>
          </div>
