        ...
        <div className="contact-grid">
          ...
          <div className="contact-info-panel">
            ...
            <div className="contact-icon-row">
              <Icons.Phone />
              <div className="contact-details">
                <p className="highlight">+91 94426 19772 <span className="sub">(MD)</span></p>
                <p className="highlight">+91 063811 00663 <span className="sub">(Main)</span></p>
              </div>
            </div>
