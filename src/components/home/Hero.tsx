        ...
        <div className="hero__body">
          <div className="hero__center">
            <h1 className="hero__h1">
              <span className="hero__company-name" style={{ display: 'block', marginBottom: '16px', color: '#ffffff', fontSize: '1.2em', whiteSpace: 'nowrap', textAlign: 'center', width: '100%', marginLeft: '-24px' }}>HEBRON AUTOMOTIVE PRODUCTS</span>
